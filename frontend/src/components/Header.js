...
const Header = () => {
  return (
    <header className='absolute left-0 right-0  bg-[#000] px-12 py-4 m-1 rounded-t-2xl z-10'>
      <div className='flex justify-center sm:justify-between items-center text-white'>
        <div className='flex items-center gap-2'>
          <div>
            <svg
              className="abstract-logo logo w-[35px] sm:w-[126px] h-8"
          ...
          <p className='text-lg sm:text-xl'> | Help Center</p>
        </div>
        <div className='hidden sm:block'>
          <button className='py-2 px-4 text-sm font-medium  rounded-lg border border-gray-600 bg-gray-900 text-gray-200 hover:bg-gray-700'>Submit a request</button>
        </div>
